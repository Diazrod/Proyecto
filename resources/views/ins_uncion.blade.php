...
<div class="content-header d-flex align-items-center justify-content-between">
    ...
    <a href="{{ url('/sacramentos/uncion') }}" class="btn btn-danger" style="font-size: 16px; margin-top: -85px;">
...
@endif
        <form id="miFormulario" action="{{ route('crearUncion') }}" method="POST" class="row g-3 needs-validation" novalidate>
    ...
    <i class="fas fa-calendar-alt"></i> Fecha de Uncion:
...
<div class="form-group">
    <label for="campo4" style="font-size: 16px;">Nombre Lugar Uncion:</label>
...
<div class="input-group d-flex justify-content-center">
    ...
    <a href="/sacramentos/uncion" class="btn btn-danger ms-2" id="btnCancelar">
