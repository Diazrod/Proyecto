...
<div class="content-header d-flex align-items-center justify-content-between">
    ...
    <a href="{{ url('/sacramentos/confirmacion') }}" class="btn btn-danger" style="font-size: 16px; margin-top: -85px;">
...
@endif
        <form id="miFormulario" action="{{ route('crearConfirmacion') }}" method="POST" class="row g-3 needs-validation" novalidate>
...
<div class="col-md-4">
  <div class="form-group">
    ...
    <div class="invalid-feedback">
        ...
        <div class="col-md-6 ">
            <fieldset style="border: 4px solid #CCFBF1; padding: 10px; margin-bottom: 15px; height: 100%; " >
            <legend><i class="fas fa-list-alt"></i> Datos Registro</legend>
.
                <div class="row">
...
<div class="col-md-4">
    <div class="form-group">
        ...
        <input type="text" id="nombrep" name="nombreP" class="form-control form-control-sm" style="width: 100%; pointer-events: none;" required>
        <div class="invalid-feedback">
            Selecciones Una Persona.
        </div>
    </div>
</div>
...
<div class="col-md-2">
    <div class="form-group">
        ...
        <input type="text" id="dnip" name="dnip" class="form-control form-control-sm" style="width: 100%; pointer-events: none;" required>
        <div class="invalid-feedback">
...
<div class="col-md-3">
    <div class="form-group">
        <label for="ciudad_nacimiento" style="font-size: 16px;">Ciudad Nacimiento:</label>
        <input type="text" id="ciudad_nacimiento" name="ciudad_nacimiento" class="form-control form-control-sm" style="width: 100%;" required maxlength="100">
        <div class="invalid-feedback">
...
<div class="container">
    ...
    <div class="col-md-7">
        <div class="form-group">
            ...
            <input type="text" id="ParoquiaB" name="Parroquia_B" class="form-control form-control-sm" style="width: 100%;" required maxlength="100">
            <div class="invalid-feedback">
                Este campo es requerido.
            </div>
        </div>
    ...
    <div class="col-md-5">
        <div class="form-group">
            ...
            <input type="date" id="FechaB" name="FechaB" class="form-control form-control-sm" style="width: 100%;" required>
            <div class="invalid-feedback">
                Este campo es requerido.
            </div>
        </div>
...
<div class="modal fade" id="resultadosModal4" tabindex="-1" aria-labelledby="resultadosModalLabel4" aria-hidden="true">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="text" id="cod_monseñor" name="cod_monseñor" class="form-control form-control-sm" style="width: 100%; pointer-events: none;" required>
            <div class="invalid-feedback">
    ...
    <div class="col-md-5">
        <div class="form-group">
            ...
            <input type="text" id="nombre_monseñor" name="nombre_monseñor" class="form-control form-control-sm" style="width: 100%; pointer-events: none;" required>
            <div class="invalid-feedback">
                Selecciones una Persona
            </div>
        </div>
    ...
    <div class="col-md-4">
        <div class="form-group">
            <label for="dni_monseñor" style="font-size: 16px;">DNI :</label>
            <input type="text" id="dni_monseñor" name="dni_monseñor" class="form-control form-control-sm" style="width: 100%; pointer-events: none;" required>
            <div class="invalid-feedback">
        ...
        <div class="modal-content" style="background-color: #FFFFFF; border: 6px solid #48C9B0;">
            ...
            <a href="/Feligreses" class="btn btn-success position-absolute top-3 start-3 m-0 p-2 text-white" style="width: 43px; height: 43px; line-height: 1;" aria-label="Add New">
                ...
                <div class="form-group row align-items-center">
                    ...
                    <div class="col-md-4">
                        <label for="dni_padre" style="font-size: 16px;">DNI :</label>
                        ...
                        <div class="d-flex">
                            <div class="me-3" style="flex: 1;">
                                ...
                                <div class="d-flex mb-3">
                                    <input type="text" id="padrinoInput" class="form-control form-control-Sl me-2" maxlength="50" style="flex: 1;" placeholder="Nombre del padrino">
...
<br>
    ...
    <a href="/sacramentos/confirmacion" class="btn btn-danger ms-2" id="btnCancelar">
...
<script>
    document.getElementById('ParoquiaB').addEventListener('input', function(e) {
...
document.getElementById('ciudad_nacimiento').addEventListener('input', function(e) {
    // Reemplaza cualquier carácter que no sea alfanumérico
    this.value = this.value.replace(/[^A-Za-zñÑ \s]/g, '');
});
    ...
    $(document).ready(function() {
        ...
        function cargarTablaResultados2() {
            ...
            $('#tablaResultados4').on('click', '.btnCopiarParroco2', function() {
                ...
                // Ejemplo de cómo actualizar los campos de parroco con los datos de la persona seleccionada
                $('#cod_monseñor').val(codigoPersona);
                $('#nombre_monseñor').val(nombrePersona);
                $('#dni_monseñor').val(dniPersona);
