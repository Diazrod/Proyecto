...
<div class="content-header d-flex align-items-center justify-content-between">
    ...
    <div class="text-center flex-grow-1">
        <h1 class="fw-bold" style="font-style: italic; font-family: 'Algerian', sans-serif; color: black; font-size: 45px; text-shadow: 4px 4px #ffffff;">
            FORMULARIO DE ORDENACIÓN SACERDOTAL
        </h1>
    ...
    <a href="{{ url('/sacramentos/orden') }}" class="btn btn-danger" style="font-size: 16px; margin-top: -85px;">
...
@endif
        <form id="miFormulario" action="{{ route('crearOrden') }}" method="POST" class="row g-3 needs-validation" novalidate>
    ...
    <i class="fas fa-calendar-alt"></i> Fecha de Ordenacio:
    
</label>

        <input type="date" id="fecha" name="fecha" class="form-control form-control-sm" style="width: 45%; display: inline-block; margin-left: 2px;"required >
...
<br><br>
    ...
    <textarea id="observaciones" name="observaciones" class="form-control form-control-sm" rows="1" maxlength="250" style="resize: none; border: 3px solid #48C9B0;" value=""></textarea>
    
</div>

<div class="form-group">
    <label for="campo4" style="font-size: 16px;">Nombre Lugar ordenación:</label>
    <textarea id="Lugar" name="Lugar" class="form-control form-control-sm" rows="1" maxlength="200" style="resize: none; border: 3px solid #48C9B0;" value=""></textarea>
...
<div class="input-group d-flex justify-content-center">
    ...
    <a href="/sacramentos/orden" class="btn btn-danger ms-2" id="btnCancelar">
...
validateInput(document.querySelector('#Lugar'));
...
<script>
    ...
    function limpiarCampos() {
        ...
        document.getElementById('cod_parroco').value = '';
        document.getElementById('nombre_parroco').value = '';
        document.getElementById('dni_parroco').value = '';
        document.getElementById('libro_reg').value = '';
        document.getElementById('folio_reg').value = '';
        document.getElementById('numero_reg').value = '';
        document.getElementById('cod_personas').value = '';
