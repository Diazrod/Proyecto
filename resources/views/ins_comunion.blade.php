...
<div class="content-header d-flex align-items-center justify-content-between">
    ...
    <div class="text-center flex-grow-1">
        <h1 class="fw-bold" style="font-style: italic; font-family: 'Algerian', sans-serif; color: black; font-size: 45px; text-shadow: 4px 4px #ffffff;">
            FORMULARIO DE PRIMERA COMUNIÓN
        </h1>
    ...
    <a href="{{ url('/sacramentos/comunion') }}" class="btn btn-danger" style="font-size: 16px; margin-top: -85px;">
...
@endif
        <form id="miFormulario" action="{{ route('crearComunion') }}" method="POST" class="row g-3 needs-validation" novalidate>
...
<fieldset style="border: 4px solid #CCFBF1; padding: 10px; margin-bottom: 15px; height: 100%;">
    ...
    <div class="modal-dialog modal-m">
        ...
        <div class="col-md-3">
          <div class="form-group">
            <label for="fecha_nacimiento" style="font-size: 16px;">Fecha de Nacimiento:</label>
...
<div class="container">
    ...
    <div class="col-md-7">
        <div class="form-group">
            ...
            <input type="text" id="ParoquiaB" name="Parroquia_B" class="form-control form-control-sm" style="width: 100%;"  maxlength="100" required>
...
<div class="modal fade" id="resultadosModal3" tabindex="-1" aria-labelledby="resultadosModalLabel3" aria-hidden="true">
    ...
    <a href="/sacramentos/comunion" class="btn btn-danger ms-2" id="btnCancelar">
